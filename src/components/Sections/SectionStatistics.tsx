        ...
        <div className="row">
          <div className="col-sm-12 col-md-6">
            <h2 className="text-orange fs-1">
              Inúmeros motivos pra estudar na Universidade Católica do Maranhão
            </h2>
            <p className="fs-4 mb-4">
              Em 1976, a SOMACS fundou o Centro de Estudos Teológico, a
              principal missão do CET era ser um espaço fundamental para a
              formação sacerdotal, que carecia de um estudo que fosse localizado
              no próprio estado do Maranhão.
            </p>
            <button
            ...
            <div className="row">
              ...
              <div className="col-sm-12 col-md-6">
                ...
                >
                  ...
                  <p className="text-secondary">
                    Explore um referencial teórico-metodológico que proporcione
                    a compreensão profunda do fenômeno religioso pluralista
                    contemporâneo.
                  </p>
                </div>
              </div>
